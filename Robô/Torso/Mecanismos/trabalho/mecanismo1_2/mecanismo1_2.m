% função x2 = l2 + ((l1 + l2 - sqrt(l1^2 + l2^2))/2)*cos(t) e y2 = - l1 + ((l1 + l2 - sqrt(l1^2 + l2^2))/4)*sin(t)
%função escolhida para não haver singularidade
...
PhiD=[x2 - l2 - ((l1 + l2 - sqrt(l1^2 + l2^2))/2)*cos(t);
      y2 + l1 - ((l1 + l2 - sqrt(l1^2 + l2^2))/4)*sin(t)];
